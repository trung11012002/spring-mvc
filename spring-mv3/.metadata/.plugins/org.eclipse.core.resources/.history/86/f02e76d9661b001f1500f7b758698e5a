...
<c:url var="editCategoryURL" value="/quan-tri/loai/chinh-sua" />
			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<form:form action="${editCategoryURL}" method="POST"
							class="form-horizontal" role="form" id="formSubmit"
							modelAttribute="model" accept-charset="UTF-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input path="code" id="code" cssClass="col-xs-10 col-sm-5" />
								</div>
							</div>
							...
							<div class="clearfix form-actions">
								<div class="col-md-offset-3 col-md-9">
									<c:if test="${not empty model.id}">
										<button class="btn btn-info" id="btnAddOrUpdate" type="submit">
											<i class="ace-icon fa fa-check bigger-110"></i> Cập nhật loại
											bài viết
										</button>
									</c:if>
									<c:if test="${empty model.id}">
										<button class="btn btn-info" type="button" id="btnAddOrUpdate">
											<i class="ace-icon fa fa-check bigger-110"></i> Thêm loại bài
											viết
										</button>
									</c:if>
									&nbsp; &nbsp; &nbsp;
