...
<c:url var="categoryURL" value="/quan-tri/loai/danh-sach" />
<c:url var="deleteCategoryURL" value="/quan-tri/loai/xoa" />
...
<body>
	<div class="main-content">
		<form action="<c:url value='/quan-tri/loai/danh-sach'/>"
